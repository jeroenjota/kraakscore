...
<template>
  <div>
    ...
    <button
      @click="open = true"
      class="bg-gray-200 text-white px-4 py-2 rounded hover:bg-blue-600 btn"
      v-tooltip="'QR-code voor de link naar de PDF'">
    ...
    <div
      ...
      <div
        ...
        <button @click="copyLink" class="mt-4 text-sm underline text-gray-600">
          📋 Kopieer link
        </button>
      </div>
    </div>
